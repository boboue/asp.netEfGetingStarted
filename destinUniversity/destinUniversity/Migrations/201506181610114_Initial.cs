namespace destinUniversity.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        DepartmentIDRefId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.CourseID)
                .ForeignKey("dbo.Department", t => t.DepartmentIDRefId, cascadeDelete: true)
                .Index(t => t.DepartmentIDRefId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Course", "DepartmentIDRefId", "dbo.Department");
            ...
            DropIndex("dbo.Course", new[] { "DepartmentIDRefId" });
